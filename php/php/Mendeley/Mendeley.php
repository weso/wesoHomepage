...
define('API_KEY',"585e56cc184d3811c0771fdb805a09f605200ac67");
...
class Mendeley {
	...
	function fetch_docs_in_group($group_id) {
		$api_docs_in_group="http://api.mendeley.com/oapi/documents/groups/%s/docs/?details=true&items=-1&consumer_key=%s";	
		$url=sprintf($api_docs_in_group,$group_id,$this->consumer_key);
		
		try {
			$codigo = $this->get_http_response_code($url);
